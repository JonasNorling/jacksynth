...
#define VAL2MS(n) exp2f((n-12)/8.0f)
  ...
  case 29: // OSC1 detune
    SetParameter(0, PARAM_OSC_DETUNE, value, true); break;
  case 33: // OSC1 pulsewidth
    SetParameter(0, PARAM_PULSE_WIDTH, value, true); break;
  case 52: // OSC1 level
    SetParameter(0, PARAM_OSC_LEVEL, value, true); break;

  case 35: // OSC2 octave
    SetParameter(1, PARAM_OSC_OCTAVE, value, true); break;
  case 37: // OSC2 detune
    SetParameter(1, PARAM_OSC_DETUNE, value, true); break;
  ...
  case 44: // OSC3 detune
    SetParameter(2, PARAM_OSC_DETUNE, value, true); break;
  ...
  case  95: // Filter env attack
    SetParameter(0x00, PARAM_ENVELOPE, VAL2MS(value), true); break;
  case  96: // Filter env decay
    SetParameter(0x01, PARAM_ENVELOPE, VAL2MS(value), true); break;
  case  97: // Filter env sustain
    SetParameter(0x02, PARAM_ENVELOPE, value, true); break;
  case 100: // Filter env release
    SetParameter(0x03, PARAM_ENVELOPE, VAL2MS(value), true); break;

  case 101: // Amp env attack
    SetParameter(0x10, PARAM_ENVELOPE, VAL2MS(value), true); break;
  case 102: // Amp env decay
    SetParameter(0x11, PARAM_ENVELOPE, VAL2MS(value), true); break;
  case 103: // Amp env sustain
    SetParameter(0x12, PARAM_ENVELOPE, value, true); break;
  case 106: // Amp env release
    SetParameter(0x13, PARAM_ENVELOPE, VAL2MS(value), true); break;
